...
- Multi-timeframe capture belongs only to the runtime advertising the ChartViz Cloud capability; Cloud requests use the fixed reviewed ChartViz origin and validated extension contract.
