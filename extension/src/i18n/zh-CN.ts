...
export const zhCN: Record<TranslationKey, string> = {
  ...
  detectedChart: '已检测图表', detectedChartHelp: '确认当前图表信息后，ChartViz 将截取并开始分析。', waitingForChart: '正在等待图表…', captureAnalyze: '截图并分析', capturingChart: '正在截取图表…', refreshChartDetection: '重新检测图表', exchange: '交易所', notDetected: '未识别', chartUnavailable: '当前图表不可用', chartDetectionError: '无法检测当前图表。', chartCaptureError: '无法截取当前图表。', unsupportedPage: '当前页面暂不支持', unsupportedChartHelp: '请打开下方任一已支持站点的图表页面。', supportedSites: '支持的站点',
